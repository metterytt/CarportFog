...
public class StorageFacade {
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#addCustCalc(int, int, int, int, int)}
     * @param length
     * @param width
     * @param angle
     * @param shedLength
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#addRequest(int, int, int, int, int, int, int)}
     * @param customerID
     * @param length
     * @param width
     * @param angle
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#editRequest(int, int, int, int, int, int, int)}
     * @param orderID
     * @param length
     * @param width
     * @param angle
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#updateTotalPrice(int, int)}
     * @param price
     * @param orderID
     * @throws CarportException 
     */
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#addBomToOrder(java.util.List, int, int)}
     * @param listToBeSaved
     * @param orderID
     * @param empID
     * @throws CarportException 
    ...
    /**
     * is described in OrderMapper: {@link  OrderMapper#getOrderTotalPrice(int)}
     * @param orderID
     * @return
     * @throws CarportException 
     */
    ...
    /**
     * is described in UserMapper: {@link  UserMapper#loginCustomer(java.lang.String, java.lang.String)}
     * @param username
     * @param password
     * @return
     * @throws CarportException 
    ...
    /**
     * is described in UserMapper: {@link  UserMapper#registerEmp(java.lang.String, java.lang.String, java.lang.String)}
     * @param username
     * @param password
     * @param role
     * @throws CarportException 
    ...
    /**
     * is described in UserMapper: {@link  UserMapper#registerCustomer(functionLayer.entity.Customer)}
     * @param customer
     * @throws CarportException 
     */
