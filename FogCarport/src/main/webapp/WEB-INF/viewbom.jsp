        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    <%= RenderTables.getListOfProducts(bom, orderID, length, width, angle, shedLength, shedWidth)%>
                    ...
                    <%= RenderTables.getListOfProducts(shedBom, orderID, length, width, angle, shedLength, shedWidth)%>
